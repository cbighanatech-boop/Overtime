...
The React Compiler is not enabled on this template because of dev & build performances. To add it, see [this documentation](https://react.dev/learn/react-compiler/installation).
